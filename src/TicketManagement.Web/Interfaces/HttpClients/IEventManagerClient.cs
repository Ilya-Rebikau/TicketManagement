...
namespace TicketManagement.Web.Interfaces.HttpClients
{
    ...
    public interface IEventManagerClient
    {
        ...
        public Task<IEnumerable<EventAreaViewModel>> GetEventAreaViewModels([Header(AuthorizationKey)] string token, [Query] int pageNumber, CancellationToken cancellationToken = default);
        ...
        public Task<IEnumerable<EventViewModel>> GetEventViewModels([Header(AuthorizationKey)] string token, [Query] int pageNumber, CancellationToken cancellationToken = default);
        ...
        public Task<IEnumerable<TicketViewModel>> GetTicketViewModels([Header(AuthorizationKey)] string token, [Query] int pageNumber, CancellationToken cancellationToken = default);
